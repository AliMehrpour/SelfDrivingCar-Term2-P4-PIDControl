...
* The D (differential) component neutralizes the P component's tendency to overshoot the center line. The proper value of D helps the car to approach the center line smoothly.

* The I (integral) component neutralizes a bias in the CTE which prevents P-D controller from reaching the center line by sum-up teh CTE over time.


# Hyperparameter Tunning
All parameters were tunded manually because wrong parameters quickly lead to unrecoverable crashes of the car and require a manual restart the simulator. I started with values given in the class which is 0.2, 0.004, 3.0 and followed this algorithm to tune them:
1. Single P controller for one setpoint, with Ki=0 and Kd=0
2. Increase Kd until oscillations subside
3. In case of crashes:
